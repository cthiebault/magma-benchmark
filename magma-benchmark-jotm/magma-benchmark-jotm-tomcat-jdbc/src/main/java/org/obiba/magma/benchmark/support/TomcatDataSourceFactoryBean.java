...
package org.obiba.magma.benchmark.support;
...
public class TomcatDataSourceFactoryBean implements FactoryBean<DataSource> {

  private static final Logger log = LoggerFactory.getLogger(TomcatDataSourceFactoryBean.class);
